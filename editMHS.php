...
?> 
    ...
    <form action="prosesEdit.php" method="POST"> 
        <fieldset> <input type="hidden" name="id" value="<?php echo $data['id'] ?>" /> 
        <p> 
        ...
        <p> 
            <label for="angkatan">Angkatan : </label> <input type="text" name="angkatan" placeholder="Angkatan" value="<?php echo $data['angkatan']; ?> "> 
        </p> 
        <p> 
